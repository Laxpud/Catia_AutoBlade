...
- [ ] 定位并解决密集翼型点云在 CATIA 中的几何精度冲突。
  ...
  - 手工检查：测试输入为 `input/airfoils/AIRFOIL1_sharp_1000.csv`；成功截面与 Loft 失败现场分别保存在 `output/repro/AIRFOIL1_sharp_1000_sections.CATPart` 和 `output/repro/AIRFOIL1_sharp_1000_loft_failure.CATPart`。
