...
- `docs/archive/`：已经完成或被当前架构取代的历史计划；现有记录见[截至 0.1.1 的已完成里程碑](archive/milestones-through-0.1.1.md)、[`v0.2.0` 内部 preview wheel 里程碑](archive/internal-preview-wheel-0.2.0.md)和[显式参数扫描 `sweep` 里程碑](archive/explicit-parameter-sweep.md)。
